...
function timer(intDiff) {
    ...
    setInterval(function() {
        ...
        if (intDiff == 0) {
            $(".mas").hide();
            if (usertype == 0 && username == "system") {
                send("admin", "系统管理员", "admin.jpg", '<span style="color:red;">本期投注截止，请等待开奖</span>')
            }
            $("#dexL1").html("已经封盘，开奖中...");
...
var msg = ["三军" + " " + mt_rand(1, 6) + " " + mt_rand(1, 9) + "00", "涨跌" + " 涨" + " " + mt_rand(1, 9) + "00", "涨跌" + " 跌" + " " + mt_rand(1, 9) + "00", "红绿" + " 红" + " " + mt_rand(1, 9) + "00", "红绿" + " 绿" + " " + mt_rand(1, 9) + "00"];
function robmsg() {
    ...
    setInterval(function() {
        ...
        function(data) {
            if (data == "已封盘") {
                ...
                get_balance();
                if (usertype == 0 && username == "system") {
                    send("admin", "系统管理员", "admin.jpg", "本期投注开始，祝君中奖")
                }
                $("#dexL1").html("距离封盘还有");
